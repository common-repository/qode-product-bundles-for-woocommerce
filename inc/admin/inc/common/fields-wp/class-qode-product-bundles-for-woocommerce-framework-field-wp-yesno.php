...
class Qode_Product_Bundles_For_WooCommerce_Framework_Field_WP_YesNo extends Qode_Product_Bundles_For_WooCommerce_Framework_Field_WP_Type {
	...
	public function render_field() {
		...
		<div class="qodef-yesno qodef-field" data-option-name="<?php echo esc_attr( $this->name ); ?>" data-option-type="yesno">
			...
			<label for="<?php echo esc_attr( $this->name ); ?>-yes">
				<?php esc_html_e( 'Yes', 'qode-product-bundles-for-woocommerce' ); ?>
			</label>
			...
			<label for="<?php echo esc_attr( $this->name ); ?>-no">
				<?php esc_html_e( 'No', 'qode-product-bundles-for-woocommerce' ); ?>
			</label>
		</div>
		<?php
	}
